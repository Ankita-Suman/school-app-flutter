...
static TextStyle blk10w400 = TextStyle(
 ...
 static TextStyle greyDark14 = TextStyle(
  ...
  static TextStyle lightBlueDark10 = TextStyle(
      ...
      fontSize: Dimens.ten,
      fontWeight: FontWeight.w400,
      color: ColorsValue.lightBlueClrText);

static TextStyle darkGrey16 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.sixteen,
      fontWeight: FontWeight.w400,
      color: ColorsValue.darkGreyBgClr);

static TextStyle darkGrey20= TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.twenty,
      fontWeight: FontWeight.w400,
      color: ColorsValue.darkGreyBgClr);

  static TextStyle darkBlueDark16 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.sixteen,
      fontWeight: FontWeight.w700,
      color: ColorsValue.primaryColorText);

  static TextStyle darkBlueDark12 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.twelve,
      fontWeight: FontWeight.w700,
      color: ColorsValue.signInButtonColor);

  static TextStyle darkBlueDark12w600 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.twelve,
      fontWeight: FontWeight.w600,
      color: ColorsValue.signInButtonColor);
...
static TextStyle lightSky12w400 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.twelve,
      fontWeight: FontWeight.w400,
      color: ColorsValue.lightSkyBlueB);

static TextStyle greyBg14w400 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.fourteen,
      fontWeight: FontWeight.w400,
      color: ColorsValue.greyBgClr);

static TextStyle blk12 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.twelve,
      fontWeight: FontWeight.w500,
      color: ColorsValue.blackColor);
...
static TextStyle darkBlue16w700 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.sixteen,
      fontWeight: FontWeight.w700,
      color: ColorsValue.primaryColorText);

static TextStyle darkBlue12w700 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.twelve,
      fontWeight: FontWeight.w700,
      color: ColorsValue.primaryColorText);
  ...
  static TextStyle darkBlue12 = TextStyle(
      fontFamily: 'Inter',
      fontSize: Dimens.twelve,
      fontWeight: FontWeight.w400,
      color: ColorsValue.primaryColorText);

...
abstract class Dimens {
  ...
  static double hundredSeventyFour = 174.sp;
  static double hundredEighty = 180.sp;
  static double hundredEightyFive = 185.sp;
  ...
  static double threeEighty = 380.sp;
  ...
  static double fourHundredSeventy = 470;
  ...
  static EdgeInsets edgeInsetsTop3 = EdgeInsets.only(top: three);
  ...
  static EdgeInsets edgeInsets0_10_0_00 = EdgeInsets.only(
    top: ten,
  );
  static EdgeInsets edgeInsets0_0_0_24 = EdgeInsets.only(
    bottom: twentyFour,
  );
  ...
  static EdgeInsets edgeInsetsLeft25 = EdgeInsets.only(left: twentyFive);

  static EdgeInsets edgeInsetsLeft10 = EdgeInsets.only(left: ten);
  static EdgeInsets edgeInsetsLeft8 = EdgeInsets.only(left: eight);

  static EdgeInsets edgeInsetsTopt10 = EdgeInsets.only(top: twelve);
  static EdgeInsets edgeInsetsBottomt10 = EdgeInsets.only(bottom: twelve);

  static EdgeInsets edgeInsetsTop20 = EdgeInsets.only(top: twenty);
  static EdgeInsets edgeInsetsTop15 = EdgeInsets.only(top: twelve);
  ...
  static EdgeInsets edgeInsetsTop5 = EdgeInsets.only(top: five);
  ...
  static EdgeInsets edgeInsets24 = EdgeInsets.symmetric(
    horizontal: Dimens.twentyFour,
  );
  static EdgeInsets edgeInsetsHorizontal20 = EdgeInsets.symmetric(
    horizontal: Dimens.twenty,
  );
  static EdgeInsets edgeInsetsVertical20 = EdgeInsets.symmetric(
    vertical: Dimens.twenty,
  );
  static EdgeInsets edgeInsetsHorizontal12 = EdgeInsets.symmetric(
    horizontal: Dimens.twelve,
  );
  static EdgeInsets edgeInsetsHorizontal2 = EdgeInsets.symmetric(
  ...
  static EdgeInsets edgeInsets20_0_8_0 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    eight,
    zero,
  );
  static EdgeInsets edgeInsets5_8_5_8 = EdgeInsets.fromLTRB(
    five,
    eight,
    five,
    eight,
  );
  static EdgeInsets edgeInsets12_8_4_8 = EdgeInsets.fromLTRB(
    twelve,
    eight,
    four,
    eight,
  ...
  static EdgeInsets edgeInsets16_0_24_0 = EdgeInsets.fromLTRB(
    sixteen,
    zero,
    twentyFour,
    zero,
  ...
  static EdgeInsets edgeInsets16_0_24_12 = EdgeInsets.fromLTRB(
    sixteen,
    zero,
    twentyFour,
    twelve,
  ...
  static EdgeInsets edgeInsets20_10_20_0 = EdgeInsets.fromLTRB(
    twenty,
    ten,
    twenty,
    zero,
  ...
  static EdgeInsets edgeInsets0_10_8_10 = EdgeInsets.fromLTRB(
    zero,
    ten,
    eight,
    ten,
  ...
  static EdgeInsets edgeInsets20_20_10_0 = EdgeInsets.fromLTRB(
    twenty,
    twenty,
    ten,
    zero,
  ...
  static EdgeInsets edgeInsets24_0_16_0 = EdgeInsets.fromLTRB(
    twentyFour,
    zero,
    sixteen,
    zero,
  ...
  static EdgeInsets edgeInsets16_11_16_11 = EdgeInsets.fromLTRB(
    sixteen,
    eleven,
    sixteen,
    eleven,
  ...
  static EdgeInsets edgeInsets0_12_0_12 = EdgeInsets.fromLTRB(
    zero,
    ten,
    zero,
    ten,
  );
  static EdgeInsets edgeInsets27_0_27_0 = EdgeInsets.fromLTRB(
    twentySeven,
    zero,
    twentySeven,
    zero,
  ...
  static EdgeInsets edgeInsets0_1_0_1 = EdgeInsets.fromLTRB(
    zero,
    one,
    zero,
    one,
  ...
  static EdgeInsets edgeInsets22_10_18_15 = EdgeInsets.fromLTRB(
    twentyTwo,
    ten,
    eighteen,
    fifteen,
  ...
  static EdgeInsets edgeInsets16_12_16_8 = EdgeInsets.fromLTRB(
    sixteen,
    twelve,
    sixteen,
    eight,
  ...
  static EdgeInsets edgeInsets16_0_12_0 = EdgeInsets.fromLTRB(
    sixteen,
    zero,
    twelve,
    zero,
...
static EdgeInsets edgeInsets0_3_0_0 = EdgeInsets.fromLTRB(
  ...
  static EdgeInsets edgeInsets14_10_0_0 = EdgeInsets.fromLTRB(
    fourteen,
    ten,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets24_38_0_0 = EdgeInsets.fromLTRB(
    twentyFour,
    thirtyEight,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets20_13_20_13 = EdgeInsets.fromLTRB(
    twenty,
    thirteen,
    twenty,
    thirteen,
  ...
  static EdgeInsets edgeInsets0_0_0_50 = EdgeInsets.fromLTRB(
    zero,
    zero,
    zero,
    fifty,
 ...
 static EdgeInsets edgeInsets0_15_10_0 = EdgeInsets.fromLTRB(
  ...
  static EdgeInsets edgeInsets2_0_2_2 = EdgeInsets.fromLTRB(
    two,
    zero,
    two,
    two,
  ...
  static EdgeInsets edgeInsets6_0_0_0 = EdgeInsets.fromLTRB(
    six,
    zero,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets14_0_14_0 = EdgeInsets.fromLTRB(
    fourteen,
    zero,
    fourteen,
    zero,
  ...
  static EdgeInsets edgeInsets24_0_24_24 = EdgeInsets.fromLTRB(
    twentyFour,
    zero,
    twentyFour,
    twentyFour,
  );
  static EdgeInsets edgeInsets24_0_24_8 = EdgeInsets.fromLTRB(
    twentyFour,
    zero,
    twentyFour,
    eight,
  ...
  static EdgeInsets edgeInsets20_0_10_0 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    ten,
    zero,
  );
  static EdgeInsets edgeInsets10_0_20_0 = EdgeInsets.fromLTRB(
    ten,
    zero,
    twenty,
    zero,
...
static EdgeInsets edgeInsets5_0_20_20 = EdgeInsets.fromLTRB(
  ...
  static EdgeInsets edgeInsets0_10_0_15 = EdgeInsets.fromLTRB(
    zero,
    ten,
    zero,
    fifteen,
  ...
  static EdgeInsets edgeInsets15_30_20_0 = EdgeInsets.fromLTRB(
    fifteen,
    thirty,
    twenty,
    zero,
  ...
  static EdgeInsets edgeInsets0_0_6_7 = EdgeInsets.fromLTRB(
    zero,
    zero,
    six,
    seven,
  ...
  static EdgeInsets edgeInsets18_15_18_15 = EdgeInsets.fromLTRB(
    eighteen,
    fifteen,
    eighteen,
    fifteen,
  ...
  static EdgeInsets edgeInsets10_10_0_0 = EdgeInsets.fromLTRB(
    ten,
    ten,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets25_15_25_15 = EdgeInsets.fromLTRB(
    twentyFive,
    fifteen,
    twentyFive,
    fifteen,
  ...
  static EdgeInsets edgeInsets25_15_0_15 = EdgeInsets.fromLTRB(
    twentyFive,
    fifteen,
    zero,
    fifteen,
  ...
  static EdgeInsets edgeInsets25_5_25_5 = EdgeInsets.fromLTRB(
    twentyFive,
    five,
    twentyFive,
    five,
  ...
  static EdgeInsets edgeInsets24_52_24_50 = EdgeInsets.fromLTRB(
    twentyFour,
    fiftyTwo,
    twentyFour,
    fifty,
  );
  static EdgeInsets edgeInsets24_60_24_50 = EdgeInsets.fromLTRB(
    twentyFour,
    seventy,
    twentyFour,
    fifty,
  );
  static EdgeInsets edgeInsets24_40_24_50 = EdgeInsets.fromLTRB(
    twentyFour,
    fourty,
    twentyFour,
    fifty,
  );
  static EdgeInsets edgeInsets12_29_12_66 = EdgeInsets.fromLTRB(
    twelve,
    twentyNine,
    twelve,
    sixtySix,
  ...
  static EdgeInsets edgeInsets42_18_24_18 = EdgeInsets.fromLTRB(
    fourtyTwo,
    eighteen,
    twentyFour,
    eighteen,
  ...
  static EdgeInsets edgeInsets8_0_3_0 = EdgeInsets.fromLTRB(
    eight,
    zero,
    three,
    zero,
  );
  static EdgeInsets edgeInsets24_32_24_20 = EdgeInsets.fromLTRB(
    twentyFour,
    thirtyTwo,
    twentyFour,
    twenty,
  ...
  static EdgeInsets edgeInsets20_20_0_10 = EdgeInsets.fromLTRB(
    twenty,
    twenty,
    zero,
    ten,
  ...
  static EdgeInsets edgeInsets24_10_24_10 = EdgeInsets.fromLTRB(
    twentyFour,
    thirty,
    twentyFour,
    ten,
  );
static EdgeInsets edgeInsets24_15_24_10 = EdgeInsets.fromLTRB(
    twentyFour,
    ten,
    twentyFour,
    ten,
  ...
  static EdgeInsets edgeInsets24_20_24_20 = EdgeInsets.fromLTRB(
    twentyFour,
    twenty,
    twentyFour,
    twenty,
  );
  static EdgeInsets edgeInsets15_0_12_0 = EdgeInsets.fromLTRB(
    fifteen,
    zero,
    twelve,
    zero,
  ...
  static EdgeInsets edgeInsets32_0_32_0 = EdgeInsets.fromLTRB(
    thirtyTwo,
    zero,
    thirtyTwo,
    zero,
  );
  static EdgeInsets edgeInsets32_11_32_0 = EdgeInsets.fromLTRB(
    thirtyTwo,
    eleven,
    thirtyTwo,
    zero,
  );
  static EdgeInsets edgeInsets32_0_0_0 = EdgeInsets.fromLTRB(
    thirtyTwo,
    zero,
    zero,
    zero,
  );
  static EdgeInsets edgeInsets44_0_32_0 = EdgeInsets.fromLTRB(
    fourtyFour,
    zero,
    thirtyTwo,
    zero,
  );
  static EdgeInsets edgeInsets5_2_5_2 = EdgeInsets.fromLTRB(
    five,
    two,
    five,
    two,
  );
  static EdgeInsets edgeInsets2_5_2_5 = EdgeInsets.fromLTRB(
    two,
    five,
    two,
    five,
  );
  static EdgeInsets edgeInsets48_0_48_0 = EdgeInsets.fromLTRB(
    fourtyEight,
    zero,
    fourtyEight,
    zero,
  ...
  static EdgeInsets edgeInsets0_0_8_16 = EdgeInsets.fromLTRB(
    zero,
    zero,
    eight,
    sixteen,
  );
  static EdgeInsets edgeInsets0_0_8_28 = EdgeInsets.fromLTRB(
    zero,
    zero,
    eight,
    thirtyTwo,
  );
  static EdgeInsets edgeInsets15_12_15_12 = EdgeInsets.fromLTRB(
    fifteen,
    twelve,
    fifteen,
    twelve,
  );
  static EdgeInsets edgeInsets12_5_12_5 = EdgeInsets.fromLTRB(
    twelve,
    five,
    twelve,
    five,
  ...
  static EdgeInsets edgeInsets9_8_9_8 = EdgeInsets.fromLTRB(
    seven,
    eight,
    seven,
    eight,
  ...
  static EdgeInsets edgeInsets13_19_13_19 = EdgeInsets.fromLTRB(
    thirteen,
    nineteen,
    thirteen,
    nineteen,
  ...
  static EdgeInsets edgeInsets0_5_20_5 = EdgeInsets.fromLTRB(zero, five, twenty, five);

  static EdgeInsets edgeInsets0_13_0_0 = EdgeInsets.fromLTRB(zero, thirteen, zero, zero);
  ...
  static SizedBox boxWidth25 = SizedBox(width: twentyThree + two);
  static SizedBox boxWidth29 = SizedBox(width: twentyThree + nine);
  ...
  static SizedBox boxHeight43 = SizedBox(height: fourtyFour - one);
  ...
  static SizedBox boxHeight88 = SizedBox(height: eighty+eight);
  ...
  static SizedBox boxHeight125 = SizedBox(height: hundredFifty - twentyFour);
  ...
  static SizedBox boxHeight250 = SizedBox(height: twoHundred + fifty);

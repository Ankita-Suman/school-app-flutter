// screens/forgot_password_screen.dart (updated to show inline errors)
                            ...
                            children: [
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: controller.branchCodeError.value.isNotEmpty
                                        ? Colors.red
                                        : (controller.isBranchCodeFocused.value ||
                                        controller.branchCodeController.text.isNotEmpty)
                                        ? Colors.blue.shade700
                                        : Colors.grey.shade300,
                                    width: controller.branchCodeError.value.isNotEmpty
                                        ? 1.5
                                        : (controller.isBranchCodeFocused.value ||
                                        controller.branchCodeController.text.isNotEmpty)
                                        ? 1.5
                              ...
                              if (controller.branchCodeError.value.isNotEmpty)
                                Padding(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: controller.emailError.value.isNotEmpty
                                        ...
                                        ? Colors.blue.shade700
                                        : Colors.grey.shade300,
                                    width: controller.emailError.value.isNotEmpty
                                        ? 1.5
                                        : (controller.isEmailFocused.value ||
                                        controller.emailController.text.isNotEmpty)
                                        ? 1.5

...
class MyStudentClassScreen extends StatefulWidget {
  const MyStudentClassScreen({super.key});

  @override
  State<MyStudentClassScreen> createState() => _MyStudentClassScreenState();
}

class _MyStudentClassScreenState extends State<MyStudentClassScreen> {
  // Get controller
  late final MyStudentClassController controller;
  ...
  void initState() {
    super.initState();
    controller = Get.put(MyStudentClassController(Get.find()));

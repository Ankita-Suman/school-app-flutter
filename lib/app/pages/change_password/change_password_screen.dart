                      ...
                      children: [
                        ...
                        Obx(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: (controller.isNewPasswordFocused.value || controller.newPasswordController.text.isNotEmpty)
                                    ? Colors.blue.shade700
                                    : Colors.grey.shade300,
                                width: (controller.isNewPasswordFocused.value || controller.newPasswordController.text.isNotEmpty) ? 1.5 : 1,
                              ),
                            ),
                            child: TextField(
                        ...
                        Obx(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(
                                color: (controller.isConfirmPasswordFocused.value || controller.confirmPasswordController.text.isNotEmpty)
                                    ? Colors.blue.shade700
                                    : Colors.grey.shade300,
                                width: (controller.isConfirmPasswordFocused.value || controller.confirmPasswordController.text.isNotEmpty) ? 1.5 : 1,
                              ),
                            ),
                            child: TextField(
                            ...
                            child: RichText(
                              text: TextSpan(
                                ...
                                children:  [
                                  ...
                                  TextSpan(text: 'Login', style: Styles.darkBlueW700),
                                ],
                              ),
                            ),
                          ),

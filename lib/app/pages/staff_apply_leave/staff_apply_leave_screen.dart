...
class StaffApplyLeaveScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final StaffApplyLeaveController controller = Get.put(StaffApplyLeaveController());
        ...
        children: [
          ...
          Obx(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: (controller.isLeaveTypeFocused.value || controller.selectedLeaveType.value.isNotEmpty)
                      ? Colors.blue.shade700
                      : Colors.grey.shade300,
                  width: (controller.isLeaveTypeFocused.value || controller.selectedLeaveType.value.isNotEmpty) ? 1.5 : 1,
                ),
              ),
  ...
  Widget _buildDateRangeFields(StaffApplyLeaveController controller, BuildContext context) {
    return Padding(
                    ...
                    child: Container(
                      ...
                      child: Obx(() => Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            controller.fromDate.value.isEmpty ? 'mm/dd/yyy' : controller.fromDate.value,
                            style: TextStyle(
                            color: controller.fromDate.value.isEmpty
                                ? Colors.grey.shade400  // 🔥 Light Grey when empty
                                : Colors.black87,      // 🔥 Black when selected
                          ),
                          ),
                        ],
                      )),
                    ...
                    child: Container(
                      ...
                      child: Obx(() => Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            controller.toDate.value.isEmpty ? 'mm/dd/yyy' : controller.toDate.value,
                            style: TextStyle(
  ...
  Widget _buildFileUploadSection(StaffApplyLeaveController controller, BuildContext context) {
    return Padding(
        padding: const EdgeInsets.fromLTRB(12, 4, 12, 12),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
  ...
  Widget _buildSubmitButton(StaffApplyLeaveController controller, BuildContext context) {
    return Obx(
          () => Opacity(

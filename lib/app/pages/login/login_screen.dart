...
class LoginScreen extends StatelessWidget {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildBranchCodeField(
                              controller, screenWidth, screenHeight),
                          SizedBox(height: screenHeight * 0.02),
                          _buildEmailField(
                              controller, screenWidth, screenHeight),
                          SizedBox(height: screenHeight * 0.02),
        ...
        Obx(() => Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              ...
              width: (controller.isBranchCodeFocused.value ||
                  controller.branchCodeController?.text.isNotEmpty ==
                      true)
                  ? 1.5
                  : 1,
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: (controller.isPasswordFocused.value ||
                  ...
                  ? Colors.blue.shade700
                  : Colors.grey.shade300,
              width: (controller.isPasswordFocused.value ||
                  controller.passwordController?.text.isNotEmpty ==
                      true)
                  ? 1.5
                  : 1,
  ...
  // ✅ Forgot Password: blocks only Parent
